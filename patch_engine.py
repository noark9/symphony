...
# Return None instead of false inside start_issue
content = re.sub(
...
# Change start_issue creation of ActiveSession
...
# Modify poll pushing dispatchable
